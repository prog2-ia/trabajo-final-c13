...
class ArtistaSolista(Artista):
    ...
    def info(self):
        if self.edad:
            print(f"El artista es '{self.nombre}', empezó su carrera en el año {self.__fecha_debut}, es de '{self.pais}' y tiene {self.edad} años")
        else:
            print(f"El artista es '{self.nombre}', empezó su carrera en el año {self.__fecha_debut} y es de '{self.pais}'")
